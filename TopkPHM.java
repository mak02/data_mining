...
public class TopkPHM {
  ...
  // Change
	 ...
	 */
	public void runAlgorithm(int kvar, String input, String output, int minUtility, int minPeriodicity, int maxPeriodicity, int minAveragePeriodicity, int maxAveragePeriodicity) throws IOException {
		// reset maximum
